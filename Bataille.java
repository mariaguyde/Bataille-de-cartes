...
public class Bataille {
	...
	public static void main(String[] args) {
		...
		var CarteJoueur1Couleur = carteJoueur1.getCouleur();
		...
		//var couleur = Carte.Couleurs[carteJoueur1.getCouleur()]; 
		//System.out.println("valeurs joueur 1 "+CarteJoueur1Valeur);

		var carteJoueur2 = DeckRandom2.get(0);
		var CarteJoueur2Couleur = carteJoueur2.getCouleur();
		...
		System.out.println("\n" + "===================================  Manche n° " + manche + "  ===========================================");
		System.out.println("\n" + "La carte de Mario est la suivante :  "+ CarteJoueur1Valeur + " de " + CarteJoueur1Couleur);
		System.out.println("La carte de Luigi est la suivante :  " + CarteJoueur2Valeur  + " de " + CarteJoueur2Couleur);
		...
		// Cas : où il y a égalité c'est à dire que les deux cartes ont les mêmes valeurs
			...
			var nouvelleCarteJoueur1Couleur = nouvelleCarteJoueur1CasEgalite.getCouleur();
			//System.out.println(nouvelleCarteJoueur1Couleur);
			...
			var nouvelleCarteJoueur2Couleur = nouvelleCarteJoueur2CasEgalite.getCouleur();
			//System.out.println(nouvelleCarteJoueur2Couleur);
			...
			System.out.println("\n" + "La nouvelle carte de Mario est la suivante :  "+ nouvelleCarteJoueur1Valeur + " de " + nouvelleCarteJoueur1Couleur);
			System.out.println("La nouvelle carte de Luigi est la suivante :  " + nouvelleCarteJoueur2Valeur + " de " + nouvelleCarteJoueur2Couleur);
